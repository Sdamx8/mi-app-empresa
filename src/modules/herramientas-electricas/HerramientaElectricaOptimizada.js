    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '30px' }}>
      ...
      <div>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 15px 0', color: THEME_COLORS.primary }}>📷 Fotografía</h3>
          {tool.foto_url ? (
            <img 
              src={tool.foto_url} 
              alt="Herramienta" 
        ...
        {qrCode && (
          <div style={{
            ...
            <h3 style={{ margin: '0 0 15px 0', color: THEME_COLORS.primary }}>📱 Código QR</h3>
            <img src={qrCode} alt="QR Code" style={{ maxWidth: '150px' }} />
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 15px 0', color: THEME_COLORS.primary }}>ℹ️ Información Básica</h3>
          <div style={{ fontSize: '14px', lineHeight: '1.6' }}>
            <div style={{ marginBottom: '8px' }}><strong>Serial Interno:</strong> {tool.internal_serial_number}</div>
            <div style={{ marginBottom: '8px' }}><strong>Serial Máquina:</strong> {tool.machine_serial}</div>
            <div style={{ marginBottom: '8px' }}><strong>Descripción:</strong> {tool.description}</div>
            <div style={{ marginBottom: '8px' }}><strong>Técnico:</strong> {tool.tecnico}</div>
            <div style={{ marginBottom: '8px' }}><strong>Lugar:</strong> {tool.lugar}</div>
            <div style={{ marginBottom: '8px' }}><strong>Estado:</strong> <EstadoBadge estado={tool.estado} /></div>
            {tool.fabrication_date && (
              <div style={{ marginBottom: '8px' }}>
                <strong>Fecha Fabricación:</strong> {new Date(tool.fabrication_date).toLocaleDateString('es-ES')}
              </div>
            )}
            {tool.purchase_date && (
              <div style={{ marginBottom: '8px' }}>
                <strong>Fecha Compra:</strong> {new Date(tool.purchase_date).toLocaleDateString('es-ES')}
              </div>
            )}
            {tool.invoice && (
      ...
      <div>
        <div style={{
          ...
          <h3 style={{ margin: '0 0 20px 0', color: THEME_COLORS.primary }}>
            🔧 Historial de Mantenimientos ({maintenanceHistory.length})
          </h3>
          ...
          {showMaintenanceForm && (
            <div style={{
              ...
              <h4 style={{ margin: '0 0 15px 0' }}>Nuevo Mantenimiento</h4>
              ...
              {maintenanceHistory.map((maintenance, index) => (
                <div key={maintenance.id} style={{
                  ...
                  <div style={{ fontSize: '14px', marginBottom: '8px' }}>
                    <strong>Descripción:</strong> {maintenance.descripcion}
                  </div>
                  
                  {maintenance.repuestos && (
                    <div style={{ fontSize: '14px', marginBottom: '8px' }}>
                      <strong>Repuestos:</strong> {maintenance.repuestos}
                    </div>
                  )}
                  
                  {maintenance.observaciones && (
                    <div style={{ fontSize: '14px', marginBottom: '8px' }}>
                      <strong>Observaciones:</strong> {maintenance.observaciones}
                    </div>
                  )}
                  
                  {maintenance.proxima_fecha && (
                    <div style={{ fontSize: '14px', color: THEME_COLORS.warning }}>
                      <strong>Próximo mantenimiento:</strong> {new Date(maintenance.proxima_fecha).toLocaleDateString('es-ES')}
                    </div>
                  )}
                </div>
              ))}
