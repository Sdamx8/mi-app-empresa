...
import RemisionesSpreadsheet from './components/RemisionesSpreadsheet';
...
const IngresarTrabajo = () => {
  ...
  // Estado para alternar entre vista formulario y hoja de cálculo
  ...
  // Si el modo es spreadsheet, mostrar directamente el componente
  if (viewMode === 'spreadsheet') {
    return <RemisionesSpreadsheet />;
  }
    ...
    >
      ...
      <div className="header-section">
        ...
        <div className="header-actions">
          <motion.button 
            onClick={() => setViewMode(viewMode === 'form' ? 'spreadsheet' : 'form')}
            className="toggle-view-button"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
          >
            {viewMode === 'form' ? '📊 Vista Hoja' : '📝 Vista Formulario'}
          </motion.button>
          <motion.button 
            onClick={openModal} 
