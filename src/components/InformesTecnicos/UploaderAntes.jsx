// components/InformesTecnicos/UploaderAntes.jsx
...
/**
 * Componente para cargar imágenes ANTES del servicio
 */
const UploaderAntes = ({ 
  remision, 
  imagenesIniciales = [], 
  ...
  const subirArchivos = async (archivos) => {
    ...
    try {
      ...
      console.error('Error subiendo imágenes ANTES:', err);
    ...
    <div className="space-y-4">
      ...
      {imagenes.length === 0 && !error && (
        <div className="text-center py-4">
          <p className="text-sm text-gray-500">
            Las imágenes ANTES muestran el estado inicial del vehículo o equipo antes de realizar el trabajo.
          </p>
        </div>
      )}
    </div>
